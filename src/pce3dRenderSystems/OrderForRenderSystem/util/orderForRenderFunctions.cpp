                                           ...
                                           const std::shared_ptr<orderTag> b_entity_tag)
{
    ...
    if (pce::math::calculateDistanceBetweenVectors(a_entity_tag->rigobj.vertices.at(a_entity_tag->radar.closest_vertex_id),
                                                      a_entity_tag->rigobj.vertices.at(a_entity_tag->radar.farthest_vertex_id))
     > pce::math::calculateDistanceBetweenVectors(b_entity_tag->rigobj.vertices.at(b_entity_tag->radar.closest_vertex_id),
                                                   ...
                                                   const std::shared_ptr<orderTag> b_entity_tag)
{
    ...
    //!< Also want big entity to
    //!< 3) Be bigger, according to this calc:
    if (pce::math::calculateDistanceBetweenVectors(a_entity_tag->rigobj.vertices.at(a_entity_tag->radar.closest_vertex_id), a_entity_tag->rigobj.vertices.at(a_entity_tag->radar.farthest_vertex_id))
    >  pce::math::calculateDistanceBetweenVectors(b_entity_tag->rigobj.vertices.at(b_entity_tag->radar.closest_vertex_id), b_entity_tag->rigobj.vertices.at(b_entity_tag->radar.farthest_vertex_id)))
    {
        swap = true;
    }
    ...
    {
        const double distance = pce::math::calculateDistanceBetweenVectors(
    ...
    const glm::dvec3 big_entity_face_plane_point = pce::math::calculateClosestPointInPlaneToPoint(
